...
type ISubscriptionRepository interface {
	...
	GetAll(ctx context.Context, limit, offset int) ([]*entity.Subscription, error)
	Update(ctx context.Context, id int, subscription entity.Subscription) (*entity.Subscription, error)
